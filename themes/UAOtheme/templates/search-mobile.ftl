...
<div class="hmmsd-container">
                        <form class="hmmsdc-form-search" id="search-homepage" action="${urls.search}" name="search-home" role="search" method="get" class="form-search">
                        <div id="search-home-field" class="input-form-search">
                         ...
                         <button id="search-module-submit" type="submit" value="${i18n().search_button}" class="search"><span class="icon icon-search"></span></button>
