...
var classHierarchyUtils = {
    ...
    getTheChildren: function (node) {
        ...
        $.each(node.children, function () {
            ...
            childDetails += "<td class='subclassCell'><span class='icon icon-plus' id='subclassExpand"
    ...
    makeHeaderSpansClickable: function (ctr) {
        ...
        $clickableHeader.click(function () {
            if ($clickableHeader.attr('view') == "less") {
                ...
                $('table.classHierarchy' + ctr).find('span.icon').removeClass("icon-plus");
                $('table#classHierarchy' + ctr).find('span.icon').addClass("icon-minus");
        ...
        $.each(classHierarchyUtils.clickableSpans, function () {
            ...
            $clickableSpan.click(function () {
                if ($subclassTable.is(':visible')) {
                    ...
                    $subclassTable.find('span').removeClass("icon-minus");
                    $clickableSpan.removeClass("icon-minus");
                    $clickableSpan.addClass("icon-plus")
                }
                else {
                    $subclassTable.show();
                    $clickableSpan.addClass("icon-minus");
                    $clickableSpan.removeClass("icon-plus");
                }
            });
        });
    },
    ...
    wireExpandLink: function () {
        this.expandAll.click(function () {
            if (classHierarchyUtils.expandAll.text() == i18nStrings.expandAll) {
                ...
                $('table.classHierarchy').find('span.icon').removeClass("icon-plus");
